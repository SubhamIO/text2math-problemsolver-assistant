...
from langchain.chains import LLMMathChain, LLMChain # for math operations
...
## Initializa the Math tool - TOOL 2
...
## Reasoning tool for Maths - TOOL 3
reasoning_tool=Tool(
    name="Reasoning tool",
    func=chain.run,
...
## initialize the agents using all 3 tools
